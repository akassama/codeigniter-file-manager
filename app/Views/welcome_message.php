...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?=base_url(env("CI_FM_ROUTE"))?>">CI File Manager</a></li>
        </ul>
    </div>
...
<!-- CONTENT -->
 <div class="container mt-3">
  <h3>File Manager Modal Example</h3>
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ciFileManagerModal">
    Open File Manager Modal
  </button>
  <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ciFileManagerModal2">
    Open File Manager Modal (Without Edit & Delete)
  </button>
</div>
